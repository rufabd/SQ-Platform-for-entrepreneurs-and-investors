                        ...
                        <div class="profile-details">
                            ...
                            <div class="telephone-info" style="display:block; position: relative; margin-bottom: 10px;">
                                ...
                                <div class="btnnnn" style="padding-top: 50px; padding-bottom: 20px;">
                                    <a style="text-decoration:none;  border: 1px solid orange; padding: 5px 8px; transition: 0.3s;" href="{{ route('investor-profile-edit-view', $profile->id), }}">View More and Update Your Information</a>
                                </div>
                            </div>
